<template>
  <div id="app" class="font-sans text-gray-800">
    <header
      class="border-t-4 border-blue-700 bg-white z-10 absolute w-full shadow-md"
    >
      <nav
        class="
          container
      ...
      >
        ...
        <ul
          class="
            ...
            block
            flex-grow
            lg:flex lg:flex-initial lg:w-auto
            items-center
            mt-8
            lg:mt-0
          "
        ...
        >
          <span>
            ...
            >
              <mega-menu
                v-if="menuItem.sub_menus.length > 0"
              ...
              <router-link
                ...
                >{{ menuItem["name_" + currentLocale] }}</router-link
              >
            </li>
          </span>
